...
lazy val app = project
  .settings(
    ...
    scmInfo := Some(
      ScmInfo(
        url("https://github.com/alexarchambault/test-gh-package-registry-scala-sbt"),
	"scm:git:git@github.com:alexarchambault/test-gh-package-registry-scala-sbt.git",
	"scm:git:https://github.com/alexarchambault/test-gh-package-registry-scala-sbt.git"
      )
    ),
    credentials ++= {
